...
const url = 'http://192.168.0.102:8888/api/images/product/';
                ...
                <View style={cardStyle}>
                    ...
                    <View style={imageContainer}>
                        {products.map(e => (
                            ...
                            horizontal key={e.id}>
                                <Image source={{ uri: `${url}${e.images[0]}` }} style={productImageStyle} />
                                <Image source={{ uri: `${url}${e.images[1]}` }} style={productImageStyle} />
                            </ScrollView>
                        ))}
                    </View>
                    <View style={footer}>
